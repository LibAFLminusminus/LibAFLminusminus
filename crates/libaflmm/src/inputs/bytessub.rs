...
mod tests {
    ...
    use crate::{
        corpus::{InMemoryCorpus, ObjectiveInMemoryCorpus, schedulers::QueueScheduler},
    ...
    fn test_bytessubinput_mutator() {
        ...
        let corpus: InMemoryCorpus<BytesInput, _> = InMemoryCorpus::new(corpus_sch);
        let objective_corpus = ObjectiveInMemoryCorpus::new();
