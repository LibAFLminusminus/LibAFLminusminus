/* 1.99.0-nightly */
/* qemu git hash: fb985a56196e5483de3b44c3146ede5e4c0fc8ef */
...
impl ::std::fmt::Debug for sigaction {
    fn fmt(&self, f: &mut ::std::fmt::Formatter<'_>) -> ::std::fmt::Result {
        write!(
            ...
            self.__sigaction_handler, self.sa_mask, self.sa_flags, self.sa_restorer
        )
    }
}
...
unsafe extern "C" {
    pub fn libafl_get_initial_brk() -> abi_ulong;
}
unsafe extern "C" {
    pub fn libafl_get_brk() -> abi_ulong;
}
unsafe extern "C" {
    pub fn libafl_set_brk(new_brk: abi_ulong) -> abi_ulong;
}
unsafe extern "C" {
...
pub const libafl_qemu_fatal_signal_kind_LIBAFL_QEMU_FATAL_NONE: libafl_qemu_fatal_signal_kind =
    libafl_qemu_fatal_signal_kind(0);
pub const libafl_qemu_fatal_signal_kind_LIBAFL_QEMU_FATAL_HOST: libafl_qemu_fatal_signal_kind =
    libafl_qemu_fatal_signal_kind(1);
pub const libafl_qemu_fatal_signal_kind_LIBAFL_QEMU_FATAL_TARGET: libafl_qemu_fatal_signal_kind =
    libafl_qemu_fatal_signal_kind(2);
impl ::std::ops::BitOr<libafl_qemu_fatal_signal_kind> for libafl_qemu_fatal_signal_kind {
    type Output = Self;
    #[inline]
    fn bitor(self, other: Self) -> Self {
        libafl_qemu_fatal_signal_kind(self.0 | other.0)
    }
}
impl ::std::ops::BitOrAssign for libafl_qemu_fatal_signal_kind {
    #[inline]
    fn bitor_assign(&mut self, rhs: libafl_qemu_fatal_signal_kind) {
        self.0 |= rhs.0;
    }
}
impl ::std::ops::BitAnd<libafl_qemu_fatal_signal_kind> for libafl_qemu_fatal_signal_kind {
    type Output = Self;
    #[inline]
    fn bitand(self, other: Self) -> Self {
        libafl_qemu_fatal_signal_kind(self.0 & other.0)
...
impl ::std::ops::BitAndAssign for libafl_qemu_fatal_signal_kind {
    #[inline]
    fn bitand_assign(&mut self, rhs: libafl_qemu_fatal_signal_kind) {
        self.0 &= rhs.0;
    }
}
#[repr(transparent)]
#[derive(Debug, Copy, Clone, Hash, PartialEq, Eq)]
pub struct libafl_qemu_fatal_signal_kind(pub ::std::os::raw::c_uint);
unsafe extern "C" {
    pub fn libafl_qemu_fatal_signal() -> libafl_qemu_fatal_signal_kind;
}
unsafe extern "C" {
    pub fn libafl_qemu_set_fatal_signal(kind: libafl_qemu_fatal_signal_kind);
}
unsafe extern "C" {
    pub fn libafl_sigaction(
...
unsafe extern "C" {
    pub fn libafl_sigaction_raise(signum: ::std::os::raw::c_int) -> !;
}
unsafe extern "C" {
    pub fn libafl_sigaction_abort() -> !;
}
