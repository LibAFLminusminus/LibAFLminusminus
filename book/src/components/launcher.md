...
Before launcher spawns each fuzzer, it will create a [`Worker`](./controller.md) for each of the fuzzer instance.
...
The launcher contains a `Monitor`, a [`Controller`](./controller.md), and multiple `Group`s.
