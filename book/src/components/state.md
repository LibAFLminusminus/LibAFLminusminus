...
The Corpus is where testcases are stored.
We define a Testcase as an Input and a set of related metadata like execution time for instance.
...
The taxonomy for this handling in LibAFL is Scheduler, the entity representing the policy to pop testcases from the Corpus, in a FIFO fashion for instance.
